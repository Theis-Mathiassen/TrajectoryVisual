...
def plot_trajectory_closest(origin_coords, similar_coords, dissimilar_coords, aura_delta_val, output_filename="similarity_distribution_closest.pdf"):
    ...
    # --- Delta Arrow (from origin_coords[1] to Aura Edge) ---
    o2_point = Point(origin_coords[1]) # Second origin node
    ...
    # --- Styling and Legend ---
    ax.set_title('Similarity distribution: Closest', fontsize=20, fontweight='bold', pad=25)
...
if __name__ == '__main__':
    plot_trajectory_closest(origin_coords=origin_trajectory, 
                            ...
                            output_filename='similarity_distribution_closest.pdf')
