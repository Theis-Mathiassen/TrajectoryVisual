...
def main(config):
    ...
    origRtreeParamsTraining : ParamUtil = ParamUtil(origRtree, origTrajectories, delta=7) # Temporal window for T-Drive is 3 hours
...
if __name__ == "__main__":
    ...
    config["numberOfEachQuery"] = 2000     # Number of queries used to simplify database    
